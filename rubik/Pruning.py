            ...
            while twist < 2187:
                ...
                if match:
                    ...
                    for move in MOVES:
                        ...
                        twist1 = twist_move[twist][move]
                        flip1 = flip_move[flip][move]
                        slice1 = slice_sorted_move[432 * slice_][move] // 24  # defs.N_PERM_4 = 24, 18*24 = 432

                        fs1 = (slice1 << 11) + flip1
                        fs1_classidx = fs_classidx[fs1][0]
                        fs1_sym = fs_classidx[fs1][1]
                        twist1 = conj_twist[twist1][fs1_sym]
